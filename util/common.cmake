...
function(download_url)
  cmake_parse_arguments(PARSE_ARGV 0 _ "" "NAME;URL;DEST;REVISION" "")
  get_filename_component(__DEST "${__DEST}" ABSOLUTE)
  set(stamp_file "${CMAKE_BINARY_DIR}/_deps/${__NAME}.stamp")
  set(stamp_value "${__URL}")
  if(__REVISION)
    string(APPEND stamp_value "|${__REVISION}")
  endif()
  set(cached_stamp "")
  if(EXISTS "${stamp_file}")
    file(STRINGS "${stamp_file}" cached_stamp)
  endif()
  if("${stamp_value}" STREQUAL "${cached_stamp}" AND EXISTS "${__DEST}")
